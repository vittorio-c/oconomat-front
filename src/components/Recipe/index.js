                                ...
                                <div className="recipe-ingredients">
                                    ...
                                    <ul>
                                        {recipe.data.ingredients.map(function(element){ 
                                            ...
                                            return <li key={element.aliment.id}> 
                                                <span> {element.quantity} {element.aliment.unit} </span> <span> {element.aliment.name} </span> 
                                            </li>
                                        })}
                                    </ul>
                                </div>
...
const connectionStrategies = connect(
    ...
    // VITTO : 
    // c'est ici qu'on récupère les informations du store de redux
    // et qu'on les stocke dans nos variables
    // de  <https://react-redux.js.org/api/connect> :
...
// VITTO : RecipeMain est ici le "WrappedComponent"
//
