...
const DashBoard= ({submitObjectives,objectivesInputUpdate,objectives}) => {
    return (
            <main>
                <div className="Site-content">
                    <main className="main">
                        <DashBoardForm submitObjectives = {submitObjectives} objectivesInputUpdate ={objectivesInputUpdate} objectives = {objectives} />
                    </main>
                </div>
            </main>
...
const DashBoardForm = ({submitObjectives,objectivesInputUpdate,objectives}) => (
    <div>
