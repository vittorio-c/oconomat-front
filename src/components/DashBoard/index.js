        ...
        <main>
            <div className="Site-content">
                <main className="main">
                    <AccountInfo 
                        nbPeople={nbPeople} 
                        nbPeopleInputUpdate ={nbPeopleInputUpdate} 
                        isCheck={isCheck} 
                        isCheckbox ={isCheckbox} 
                        submitNewPassword={submitNewPassword} 
                        newPassword = {newPassword} 
                        password= {password} 
                        typeOldPassword= {typeOldPassword} 
                        typeNewPassword= {typeNewPassword} 
                        submitObjectives = {submitObjectives} 
                        objectivesInputUpdate = {objectivesInputUpdate}
            ...
            <form>
                <div className="Account-info row pt-4">
                    <div className="col-lg-10 container pl-0 py-5">
                        ...
                        <p className='user mt-2 mb-2 text-center'>
                            <span className ='text-success'>
                                { 
                                    sessionStorage.getItem('userQuantity') === 'null' || sessionStorage.getItem('userQuantity') === '1' ?
                                        '1' +' personne' :
                                        sessionStorage.getItem('userQuantity')+' personnes'
                                } 
                            </span> 
                        </p>

                        <p className='password mb-2 text-center'>Password : <span className = 'text-secondary'>*********</span></p>
                        <p className ='objectif mb-2 text-center'>Objectif : 
                            <span className = 'text-success'> 
                                {sessionStorage.getItem('budget') === 'null' ? 0 : sessionStorage.getItem('budget') } € 
                            </span>
                        </p>
                                        ...
                                        <div className="modal-body">
                                            ...
                                            <div className="row d-flex align-items-center mb-4">
                                                <div className="text-center mb-3 col-md-12">
                                                    <button 
                                                        type="button" 
                                                        className="btn-submit-password btn-block btn-rounded z-depth-1" 
                                                        onClick={() =>{submitNewPassword(password,newPassword,event)}}>
                                                        {password !== newPassword ? 'Valider' : 'Error'}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="modal-dialog" role="document">
                                <div className="modal-content"> 
                                    ...
                                    <div className="modal-body">
                                        <div className="md-form mb-5">
                                            <input 
                                                onChange = {objectivesInputUpdate}  
                                                type="number" 
                                                id="inputforobjectives5" 
                                                className="form-control validate white-text" 
                                        ...
                                        <div className="md-form pb-3">
                                            <input 
                                                onChange = {nbPeopleInputUpdate}  
                                                type="number" 
                                                id="inputfornumberofpeople5" 
                                                className="form-control validate white-text" 
                                        ...
                                        <div className = "text-left text-success my-2">
                                            <input type="checkbox" 
                                                ...
                                                className = "" 
                                                onChange = {() => {isCheckbox(isCheck,event)}}/>
                                            Végétarien 
                                        </div>
                                        <div className="modal-footer">
                                            ...
                                            { objectives >0 && nbPeople > 0 ?  <button 
                                                type="button" 
                                                className="text-center" 
                                                onClick = {() => {submitObjectives(nbPeople,isCheck,event)}} 
                                                onSubmit = {() => {submitObjectives(nbPeople,isCheck,event)}} 
                                                className="btn btn-success" 
                                                type="submit" > 
                                                Valider {objectives} { objectives > 0 ? ' €' : '' } pour {nbPeople} {nbPeople < 1 ? 'personnes' :'personnes' } </button> : '' }
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    (dispatch,ownProps) => {
        return {
            ...
            objectivesInputUpdate:(event) => {
                ...
                sessionStorage.setItem('objectives',budget);
            ...
            submitObjectives:(nbPeople,isCheck,event) => {
                ...
                axios({
                    ...
                    data: {
                        budget: parseInt(sessionStorage.getItem('objectives')),
                        userQuantity : parseInt(nbPeople),
                        vegetarian: isCheck
                    },  
                }).then((response)=>{
